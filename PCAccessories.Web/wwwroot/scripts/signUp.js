        ...
        $('#submit').click(function (e) {
            ...
            $.ajax({
                ...
                [
                        ...
                        JSON.stringify(data.responseJSON.errors.Email) != null ? err.innerHTML = JSON.stringify(data.responseJSON.errors.Email[0]).replace(/"/g, "") : false,
                        ...
                        JSON.stringify(data.responseJSON.errors.ConfirmPassword) != null ? err.innerHTML = JSON.stringify(data.responseJSON.errors.ConfirmPassword[0]).replace(/"/g, "") : false
                ]
